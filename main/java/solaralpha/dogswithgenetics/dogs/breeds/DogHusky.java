...
public class DogHusky extends EntityDog{

	public DogHusky(World worldIn) {
		super(worldIn);
	}
	...
	protected void entityInit() {
		super.entityInit();
		Random r = new Random();
		this.dataManager.register(DOG_GENOTYPE, GeneticsHandler.createRandomGenotypeByBreed("Husky"));
	}
