...
public class ModelHusky extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.scale(GeneticsHandler.getSize(((DogHusky)entity).getGenotype()) * 0.25D + 0.25, GeneticsHandler.getSize(((DogHusky)entity).getGenotype()) * 0.25D + 0.25, GeneticsHandler.getSize(((DogHusky)entity).getGenotype()) * 0.25D + 0.25);
        GlStateManager.translate(-this.Body.offsetX, -this.Body.offsetY, -this.Body.offsetZ);
        GlStateManager.translate(-this.Body.rotationPointX * f5, -this.Body.rotationPointY * f5, -this.Body.rotationPointZ * f5);
        this.Body.render(f5);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
    	...
    	if (!((DogHusky) entityIn).isSitting()) {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
    	...
    	if(((DogHusky)entitylivingbaseIn).isSitting()) {
    		Body.rotateAngleX = (float) (-57 * Math.PI / 180);
    		Butt.rotateAngleX = (float) (-25 * Math.PI / 180);
    		Front.rotateAngleX = (float) (18 * Math.PI / 180);
    		this.Body.setRotationPoint(0.0F, 15.0F + (-GeneticsHandler.getSize(((DogHusky)entitylivingbaseIn).getGenotype())+3)*3, 0.0F);
    	}else{
    		Body.rotateAngleX = 0F;
    		Butt.rotateAngleX = 0F;
    		Front.rotateAngleX = 0F;
    		this.Body.setRotationPoint(0.0F, 12.0F + (-GeneticsHandler.getSize(((DogHusky)entitylivingbaseIn).getGenotype())+3)*3, 0.0F);
    	}
    }
}
