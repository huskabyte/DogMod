 ...
 * 
 * PLANS TO REVAMP! This was done VERY hurriedly when I was super tired last night (1/25/19)!
 */
public class ModelDog extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    	this.dog = (EntityDog)entity;
    	
    	if(this.dog.getBody() == 1) {
	        huskyStandModel();
    	}else {
    		eskimoStandModel();
    	}
        ...
        GlStateManager.scale((this.dog.getSize() + 1)/2.0D, (this.dog.getSize() + 1)/2.0D, (this.dog.getSize() + 1)/2.0D);
        GlStateManager.translate(-this.Body.offsetX, -this.Body.offsetY, -this.Body.offsetZ);
        GlStateManager.translate(-this.Body.rotationPointX * f5, -this.Body.rotationPointY * f5, -this.Body.rotationPointZ * f5);
        this.Body.render(f5);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
    	...
    	this.dog = (EntityDog)entityIn;
    	if(((EntityDog)entityIn).getBody() == 1) {
    		this.FrontLeftLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    		this.BackRightLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    		
    		this.FrontRightLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
    		this.BackLeftLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
    	}else {
    		this.LeftFrontLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    		this.RightBackLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    		
    		this.RightFrontLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
    		this.LeftBackLeg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
    	}
    }
    ...
    public void huskyStandModel() {
        ...
        this.Body.setRotationPoint(0.0F, 14.0F + ((-this.dog.getSize()+1)*2), 0.0F);
        ...
        this.Head = new ModelRenderer(this, 104 - (this.dog.getEyes() * 24), 33);
		...
		Front.rotateAngleX = 0;
		Butt.rotateAngleX = 0;
    }
    
    public void huskySitModel() {
    	this.textureWidth = 128;
        this.textureHeight = 45;
        this.Under2 = new ModelRenderer(this, 71, 15);
        this.Under2.setRotationPoint(0.0F, 1.0F, -0.9F);
        ...
        this.Body.addBox(-3.0F, -3.0F, -7.5F, 6, 7, 15, 0.0F);
        this.Body.rotateAngleX = (float) Math.toRadians(-81);
        this.FrontLeftLeg2 = new ModelRenderer(this, 118, 9);
        this.FrontLeftLeg2.setRotationPoint(0.0F, 2.0F, 0.0F);
        this.FrontLeftLeg2.addBox(-1.0F, -1.0F, 1.0F, 2, 8, 2, 0.0F);
        this.Tail4 = new ModelRenderer(this, 70, 0);
		...
		Front.rotateAngleX = (float) Math.toRadians(38);
		Butt.rotateAngleX = (float) Math.toRadians(-7);
    }
    
    public void eskimoStandModel(){
    	this.textureWidth = 128;
        this.textureHeight = 64;
        this.Body = new ModelRenderer(this, 0, 0);
        this.Body.setRotationPoint(0.0F, 17.5F - ((this.dog.getSize())), 0.0F);
